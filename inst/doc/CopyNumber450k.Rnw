...
\begin{figure} 
\begin{center}
<<densityplot,fig=TRUE,echo=FALSE>>=
...
\begin{figure} 
\begin{center}
<<funnormDensity,fig=TRUE,echo=FALSE>>=
...
\begin{figure} 
\begin{center}
<<quannormPCA,fig=TRUE,echo=FALSE>>=
...
\begin{figure} 
\begin{center}
<<plotSample,fig=TRUE,echo=FALSE>>=
plotSample(mcds.q, 2, main="Genomic view of Sample 2")
@
\end{center} 
...
\begin{figure} 
\begin{center}
<<plotSampleFocal,fig=TRUE,echo=FALSE>>= 
plotSample(mcds.q, 2, chr="chr5", main="Sample 2 zoom-in")
@
\end{center} 
