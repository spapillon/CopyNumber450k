...
\author[1]{Jacek Majewski}
\affil[1]{McGill University, Montreal QC, Canada}
\affil[2]{John Hopkins University, Baltimore MD, USA}
...
plotSample(mcds.f, 4, main="Genomic view of Sample 4")
@
\end{center} 
...
plotSample(mcds.f, 4, chr="chr9",
        main="Sample 4, focal amplification on chromosome 9")
@
\end{center} 
