...
setMethod("sampleChipRows", signature("CNVObject"), function(object) object@sample_chip_rows)

setMethod("sampleChipColumns", signature("CNVObject"), function(object) object@sample_chip_columns)

setMethod("sampleChipIDs", signature("CNVObject"), function(object) object@sample_chip_ids) 
