...
setGeneric("segmentize", function(object, verbose = 1, p.adjust.method = "bonferroni", min.width = 5,
                        nperm = 10000, alpha = 0.01, undo.splits = "sdundo", undo.SD = 2, trim = 0.025) standardGeneric("segmentize"))
